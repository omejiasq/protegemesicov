<template>
  ...
  <div v-else class="report-wrapper">
    ...
    <div class="report-header">
      ...
      <div class="header-badge" style="text-transform: uppercase;">{{ data.preventive.razonSocial }}</div>
        <h2>REVISIÓN DE MANTENIMIENTO PREVENTIVO</h2>
      </div>
      <div class="report-meta">
        <div class="meta-item">
          <span class="meta-label">FECHA</span>
          <span class="meta-value">{{ formatDate(data.preventive.fecha) }}</span>
        </div>
        <div class="meta-item">
          <span class="meta-label">HORA</span>
          <span class="meta-value">{{ data.preventive.hora }}</span>
        </div>
        <div class="meta-item">
          <span class="meta-label">PLACA</span>
          <span class="meta-value placa-badge">{{ data.preventive.placa }}</span>
        </div>
      </div>
    </div>
    ...
    <section class="card">
      ...
      <div class="grid">
        <div class="field">
          ...
          <span class="field-value">{{ data.preventive.placa }}</span>
        </div>
        <div class="field">
          <span class="field-label">Estado</span>
          <span class="field-value">
            <span :class="data.preventiveestado ? 'badge-active' : 'badge-inactive'">
              {{ data.preventive.estado ? 'ACTIVO' : 'INACTIVO' }}
            </span>
          </span>
        </div>
        <div class="field field-full">
          <span class="field-label">Detalle de actividades</span>
          <span class="field-value">{{ data.preventive.detalleActividades }}</span>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <div class="grid">
        <div class="field"><span class="field-label">Nombre</span><span class="field-value">{{ data.preventive.nombresResponsable }}</span></div>
        <div class="field"><span class="field-label">Documento</span><span class="field-value">{{ data.preventive.numeroIdentificacion }}</span></div>
        <div class="field"><span class="field-label">Empresa</span><span class="field-value">{{ data.preventive.razonSocial }}</span></div>
        <div class="field"><span class="field-label">NIT</span><span class="field-value">{{ data.preventive.nit }}</span></div>
      </div>
    </section>
  ...
  <section class="card" v-if="data.preventive.evidencia_foto">
    <h3 class="card-title">
  ...
  <section class="card" v-else>
    ...
    <section class="card firma-section">
      <div class="firma-box">
        ...
        <p class="firma-label">{{ data.preventive.nombresResponsable }}</p>
        <p class="firma-sub">Ingeniero Mecánico Responsable</p>
        <p class="firma-sub">CC. {{ data.preventive.numeroIdentificacion }}</p>
      </div>
    </section>
...
onMounted(async () => {
  try {
    ...
    const response = await axios.get(
      `https://sicov.protegeme.com.co/api/maintenance/maintenance-preventive/${urlId}/report`,
      {
        headers: {
    ...
    await loadImage(data.value.preventive.evidencia_foto) // ✅ agregar esta línea
  } catch (error) {
    console.error(error)
