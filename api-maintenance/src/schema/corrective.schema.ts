...
export const CorrectiveDetailSchema = SchemaFactory.createForClass(CorrectiveDetail);
CorrectiveDetailSchema.index({ enterprise_id: 1, mantenimientoId: 1 }, { unique: true });